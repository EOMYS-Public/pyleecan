...
def build_geometry_polar(self, sym=1):
    ...
    stator_yoke_list.append(Arc1(Z3, Z10, Stat_out))
    stator_yoke_list.append(Segment(Z10, Z9))
    stator_yoke_list.append(Arc1(Z9, Z7, Stat_yoke))
    stator_yoke_list.append(Arc1(Z7, Z5, -slot_int, is_trigo_direction=False))
    ...
    if slot_int != Stat_in:
        if angle_slot_opening_int == angle_slot:
            ...
            stator_isthmus_list1.append(Arc1(Z3_isthmus, Z1_isthmus, slot_int))
            ...
            stator_isthmus_list2.append(Arc1(Z2_isthmus, Z4_isthmus, slot_int))
            ...
            stator_tooth_list1.append(Arc1(Z2, Z5, Stat_yoke))
            ...
            stator_tooth_list2.append(Arc1(Z7, Z9, Stat_yoke))
            ...
            stator_isthmus_list1.append(Segment(Z1, Z3_isthmus))
            stator_isthmus_list1.append(Arc1(Z3_isthmus, Z1_isthmus, slot_int))
            stator_isthmus_list1.append(Arc1(Z1_isthmus, Zb, slot_int))
            stator_isthmus_list1.append(Segment(Zb, Za))
            stator_isthmus_list1.append(
                Arc1(Za, Z1, -Stat_in, is_trigo_direction=False)
            )

            # surf isthmus 2
            stator_isthmus_list2.append(Segment(Zd, Zc))
            stator_isthmus_list2.append(Arc1(Zc, Z2_isthmus, slot_int))
            stator_isthmus_list2.append(Arc1(Z2_isthmus, Z4_isthmus, slot_int))
            stator_isthmus_list2.append(Segment(Z4_isthmus, Z8))
