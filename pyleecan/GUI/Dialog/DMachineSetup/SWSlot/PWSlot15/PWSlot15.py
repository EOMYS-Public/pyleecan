...
class PWSlot15(Gen_PWSlot15, QWidget):
    ...
    def check(lam):
        ...
        if lam.slot.W0 is None:
            return translate("You must set W0 !", "SWSlot_15 check")
        elif lam.slot.W3 is None:
            return translate("You must set W3 !", "SWSlot_15 check")
        elif lam.slot.H0 is None:
            return translate("You must set H0 !", "SWSlot_15 check")
        elif lam.slot.H1 is None:
            return translate("You must set H1 !", "SWSlot_15 check")
        elif lam.slot.H2 is None:
            return translate("You must set H2 !", "SWSlot_15 check")
        elif lam.slot.R1 is None:
            return translate("You must set R1 !", "SWSlot_15 check")
        elif lam.slot.R2 is None:
            return translate("You must set R2 !", "SWSlot_15 check")
