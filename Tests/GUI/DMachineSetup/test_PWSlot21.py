...
class TestPWSlot21(object):
    ...
    def test_check(self):
        ...
        self.test_obj = LamSlotWind(Rint=0.1, Rext=0.2)
        self.test_obj.slot = SlotW21(H0=None, H1=0.11, H2=0.12, W0=0.13, W1=0.14, W2=0.15, H1_is_rad=False)
        self.widget = PWSlot21(self.test_obj)
        assert self.widget.check(self.test_obj) == "PWSlot21 check"
        self.test_obj.slot = SlotW21(H0=0.10, H1=None, H2=0.12, W0=0.13, W1=0.14, W2=0.15, H1_is_rad=False)
        assert self.widget.check(self.test_obj) == "PWSlot21 check"
        self.test_obj.slot = SlotW21(H0=0.10, H1=0.11, H2=None, W0=0.13, W1=0.14, W2=0.15, H1_is_rad=False)
        assert self.widget.check(self.test_obj) == "PWSlot21 check"
        self.test_obj.slot = SlotW21(H0=0.10, H1=0.11, H2=0.12, W0=None, W1=0.14, W2=0.15, H1_is_rad=False)
        assert self.widget.check(self.test_obj) == "PWSlot21 check"
        self.test_obj.slot = SlotW21(H0=0.10, H1=0.11, H2=0.12, W0=0.13, W1=None, W2=0.15, H1_is_rad=False)
        assert self.widget.check(self.test_obj) == "PWSlot21 check"
        self.test_obj.slot = SlotW21(H0=0.10, H1=0.11, H2=0.12, W0=0.13, W1=0.14, W2=None, H1_is_rad=False)
        assert self.widget.check(self.test_obj) == "PWSlot21 check"
        self.test_obj.slot = SlotW21(H0=0.10, H1=5.3, H2=0.12, W0=0.13, W1=0.14, W2=0.15, H1_is_rad=False)
        assert self.widget.check(self.test_obj) == "PWSlot21 check"