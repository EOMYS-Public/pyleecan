...
class Test_HoleM53_meth(object):
    ...
    def test_build_geometry_Z11_Z1_not_foundable(self, test_dict):
        ...
        test_obj.hole[0] = HoleM53(Zh=8, H0=0.02, H1=0.001, H2=0.01, H3=0.003, W1=0.765149757, W2=0.32542, W3=0.0564, W4=0.324)
        ...
        test_obj.hole[0] = HoleM53(Zh=8, H0=50.02, H1=10.0054456451, H2=40.56456456401, H3=0.968464003, W1=10.0, W2=0.14540, W3=1.01546654654, W4=0.05144)
    ...
    def test_build_geometry_blank(self, test_dict):
        ...
        test_obj.hole[0] = HoleM53(Zh=8, H0=0.00000000000000000000002, H1=0.00000001, H2=0.01, H3=0.003, W1=0, W2=0, W3=0.01, W4=2.28)
        test_obj.hole[0].build_geometry()
        test_obj.hole[0] = HoleM53(Zh=8, H0=0.00000000000000000000002, H1=0.00000001, H2=0.01, H3=0.003, W1=0, W2=0, W3=0.01, W4=4.78)
        test_obj.hole[0].build_geometry()
